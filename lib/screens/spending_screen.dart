...
import 'package:my_finance/blocs/income_expense/income_expense_bloc.dart';
import 'package:my_finance/blocs/income_expense/income_expense_state.dart';
import 'package:my_finance/widgets/budget_card.dart';
import 'package:my_finance/widgets/category_list.dart';
import 'package:my_finance/widgets/line_chart_widget.dart';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const BudgetCard(title: "Budget", amount: "\$2,478", progress: 0.5),
            const SizedBox(height: 16),
